...
const Carousel: FC<Props> = ({ titleStyle: TitleTag = 'h1', buttonLink, buttonStyle, textColor }) => {
    ...
    ({ items }: UniformSlotWrapperComponentProps) => {
      return (
        <MultiCarousel
          ...
          deviceType="desktop"
          renderDotsOutside
          customButtonGroup={<CarouselButtons buttonStyle={buttonStyle} colorClassName={colorClassName} />}
